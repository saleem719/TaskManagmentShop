...
$qry1 = "SELECT * from tasks left join groups on tasks.group_id = groups.group_id 
...
<div class="container">
<div class="row">
 <h2><center><i class="fas fa-tasks"></i>Tasks completed</center></h2>
<table class="table table-borderless table-hover">
      <tr>
        <th class="table-success">Task name</th>
        <th class="table-success">Assign to</th>
