...
<form action="upd_tasks.php?id=<?php echo $task_Id; ?>" method="post">
 ...
 <label>Assigned to</label>
  ...
  <option value="<?php echo $usr['group_id'];?>"<?php echo $usr['group_id'] == $stkupd['group_id'] ? 'selected disabled' : ''  ?> ><?php echo $usr['group_name']; ?></option>
<?php endwhile; ?>
  </select> 
   <br>
    <div class="form-group">
  ...
  <label>Due Date</label>
    <input type="text" name="status" class="form-control" value="<?php echo $stkupd['due_date'];?>" disabled>
  </div>
</div> 
 <div class="form-group">
  <label>Status</label>
